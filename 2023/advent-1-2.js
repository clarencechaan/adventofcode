let input = `51591twosix4dhsxvgghxq
425nine
llvmhjtr8nbbhrfone
...
function getNumAt(str, idx) {
  if ("0" <= str[idx] && str[idx] <= "9") return str[idx];
  if (str.slice(idx, idx + 3) === "one") return "1";
  if (str.slice(idx, idx + 3) === "two") return "2";
  if (str.slice(idx, idx + 5) === "three") return "3";
  if (str.slice(idx, idx + 4) === "four") return "4";
  if (str.slice(idx, idx + 4) === "five") return "5";
  if (str.slice(idx, idx + 3) === "six") return "6";
  if (str.slice(idx, idx + 5) === "seven") return "7";
  if (str.slice(idx, idx + 5) === "eight") return "8";
  if (str.slice(idx, idx + 4) === "nine") return "9";
}
