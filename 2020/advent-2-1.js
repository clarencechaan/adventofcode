let input = `1-9 x: xwjgxtmrzxzmkx
4-6 r: rrrkrgr
4-5 v: vvfvvvn
...
let output = 0;
for (let [[min, max], char, str] of input) {
  let count = str.length - str.replaceAll(char, "").length;
  if (min <= count && count <= max) output++;
}
